...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('plugins/assets/img/favicon.png') }}" rel="icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('plugins/assets/vendor/animate.css/animate.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('plugins/assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
...
<!-- Vendor JS Files -->
<script src="{{ asset('plugins/assets/vendor/purecounter/purecounter.js') }}"></script>
