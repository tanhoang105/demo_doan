    ...
    <main id="main">
        ...
        <section id="course-details" class="course-details">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <img src="https://allaravel.com/storage/app/uploads/public/5cf/90b/34a/5cf90b34a9722994965782.jpg"
                            alt="">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="course-info d-flex justify-content-between align-items-center">
                            <h5>Trainer</h5>
                            <p>
                                <select style="border: 0;background: #f6f7f6" name="" id="">
                                    @foreach ($giang_vien as $value)
                                        <option value="{{ $value->id }}">{{ $value->ten_giang_vien }}</option>
                                    @endforeach
                                </select>
                            </p>
                        </div>
                        ...
                        <div class="course-info d-flex justify-content-between align-items-center">
                            <h5>Course Fee</h5>
                            <p>{{ number_format($detail->gia_khoa_hoc) }}</p>
                        </div>
