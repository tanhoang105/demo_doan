...
@section('content')
    ...
    @endif
    <form class="p-5" action=" {{ route('route_BE_Admin_Update_Lich_Hoc') }}" method="post" enctype="multipart/form-data">
        <div class="row">
            @csrf
            <div class="col-6">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('ngay_hoc') ?? (request()->ngay_hoc ?? $res->ngay_hoc) }}" type="date"
                        name="ngay_hoc" class="form-control" id="" aria-describedby="emailHelp">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select class="form-control" name="ma_thu" id="">
                        @foreach ($thu as $item)
                            @if ($item->id == $res->ma_thu)
                                <option selected value=" {{ $item->ma_thu }} "> {{ $item->ten_thu }} </option>
                            @else
