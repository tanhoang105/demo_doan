...
@section('content')
    ...
    @endif
    <form class="p-5" action=" {{ route('route_BE_Admin_Update_Giang_Vien') }}" method="post" enctype="multipart/form-data">
        <div class="row">
            @csrf
            <div class="col-6">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('name') ?? request()->name ?? $res->ten_giang_vien }}" type="text" name="name" class="form-control"
